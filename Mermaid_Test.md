...
subgraph Total["Transcriptome_Map_to_KOREF1"]
		subgraph workflow_1[Workflow]
						subgraph workflow_2[Workflow]
									job_3["Run_RSEM_program_to_make_reference<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/transcriptome/prepareRSEMReference.md'>prepareRSEMReference</a>"]
									
						end
						subgraph workflow_4[" "]
						direction LR
						subgraph workflow_works4[Workflow]
									job_5["Run_star_program_to_map_rna_reads_on_reference_genome<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/transcriptome/mapRnaToReferenceSTAR.md'>mapRnaToReferenceSTAR</a>"]
						...
						subgraph workflow_works6[Workflow]
									job_7["Run_rsem_program_to_quantify_rna_transcripts<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/transcriptome/getExpressionLevelRSEM.md'>getExpressionLevelRSEM</a>"]
						...
						subgraph workflow_8[Workflow]
									job_9["makeInputJsonCollector<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/utils/makeFilepathTSV.md'>makeFilepathTSV</a>"]
									job_10["fastpReport_Collection<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/utils/collectInformationFromJson.md'>collectInformationFromJson</a>"]
									job_11["draw_fastpReport<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/utils/drawQCReport.md'>drawQCReport</a>"]
									job_12["makeInputSTARLogCollector<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/utils/makeFilepathTSV.md'>makeFilepathTSV</a>"]
									job_13["STARReport_Collection<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/transcriptome/collectInformationFromSTARLog.md'>collectInformationFromSTARLog</a>"]
									job_14["draw_STARReport<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/utils/drawQCReport.md'>drawQCReport</a>"]
									job_15["make_expression_matrix_cardiomics_rna_expression<br/><br/>app : <a href='https://github.com/clinomics-BI/BioPipe/tree/develop/docs/apps/transcriptome/makeReadCountMatrix.md'>makeReadCountMatrix</a>"]
									job_9-.->job_10
									job_10-.->job_11
									job_11-.->job_12
									job_12-.->job_13
